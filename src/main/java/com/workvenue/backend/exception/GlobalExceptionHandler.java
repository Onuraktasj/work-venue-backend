...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = {IllegalArgumentException.class, IllegalStateException.class, NullPointerException.class, HttpServerErrorException.InternalServerError.class})
    ...
    public ResponseEntity<BaseControllerResponse> handleControllerException(Exception ex, WebRequest request) {
        BaseControllerResponse baseControllerResponse = new BaseControllerResponse();
